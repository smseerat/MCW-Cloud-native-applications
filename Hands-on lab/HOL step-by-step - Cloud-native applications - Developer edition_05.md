...
1. Switch to the Git Bash Shell window, (If you have closed it and need to reconnect, please review the instructions on previous page i.e. "Before the HOL" page.)
...
1. In your Git Bash session connected to the build agent VM, navigate to the `~/Fabmedical` directory:
...
1. Next, navigate to the repositories in GitHub, select Actions, and then manually run the content-api workflow.
